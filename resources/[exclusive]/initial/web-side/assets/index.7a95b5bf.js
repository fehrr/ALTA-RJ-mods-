...
const Fe = "" + new URL("rr14.png", import.meta.url).href,
  Ie = "" + new URL("a45amg.png", import.meta.url).href,
  Ke = "" + new URL("r1.png", import.meta.url).href;
function J(e, t, n) {
  const r = e.slice();
  return (
    (r[4] = t[n].index),
...
function We(e, t, n) {
  let r = location.port === "5173" || !1,
    i = [
      {
        index: "rr14",
        title: "Range <br>Rover",
        subtitle: "Supercharged",
        photo: Fe,
      },
      {
        index: "a45amg",
        title: "Mercedes <br>AMG",
        subtitle: "A45",
        photo: Ie,
      },
      { index: "r1", title: "Yamaha <br>YZF", subtitle: "R1", photo: Ke },
    ];
  Se("Open", () => n(0, (r = !0)));
  async function s(u) {
